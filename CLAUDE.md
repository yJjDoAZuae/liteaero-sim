...
| Dependency management | **Conan 2.x** for Eigen3, nlohmann_json, gtest, protobuf; FetchContent for trochoids, mcap, tinygltf |
...
| mcap | v1.4.0 | MIT | FetchContent (pattern 1b — header-only) |
